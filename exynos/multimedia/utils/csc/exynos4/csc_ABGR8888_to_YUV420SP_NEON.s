    ...
    .arch armv7-a
    .text
    .global csc_ABGR8888_to_YUV420SP_NEON
    .type   csc_ABGR8888_to_YUV420SP_NEON, %function
...
LOOP_NWIDTH16:
   ...
   @-------------------------------------------YUV ------------------------------------------
    ...
    vmla.u16 q8,q4,q13  @112 * B[k]
    vmls.u16 q8,q6,q11  @q0:U -(38 * R[k]) @128<<6+ 32 + u>>2
    vmls.u16 q8,q5,q12  @-(74 * G[k])
    vshr.u16 q8,q8, #8  @(128<<8+ 128 + u)>>8

    vmov.u16 q7,q9      @CalcV()
    vmla.u16 q7,q6,q13  @112 * R[k]
    vmls.u16 q7,q5,q14  @q0:U -(94 * G[k])  @128<<6+ 32 + v>>2
    vmls.u16 q7,q4,q15  @-(18 * B[k])
